...
// ----------------------------------------------------------------------------
//dFdy dFdx如何理解:一个glsl预编译时处理的一个宏,类似c语言的sizeof
//http://gad.qq.com/article/detail/13611
...
void main()
{
    ...
    vec3 prefilteredColor = textureLod(prefilterMap, R,  roughness * MAX_REFLECTION_LOD).rgb;     //textureLod？？
