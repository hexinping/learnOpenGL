...
void OpenglWorld::createFrameBufferBySSAO(int screenWidth, int screenHeight, unsigned int *framebuffer, unsigned int *pos, unsigned int *normal, unsigned int *albedoSpec)
{
