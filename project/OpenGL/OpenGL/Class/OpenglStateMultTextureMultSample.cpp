...
bool OpenglStateMultTextureMultSample::init(string vertFile, string fragFile)
{
	float vertices[] = {
...
bool OpenglStateMultTextureMultSample::isUseEBORender()
{
	return false;
}

void OpenglStateMultTextureMultSample::rendeCommand()
{
...
int OpenglStateMultTextureMultSample::getShaderIndex()
{
	return 28;
}


bool  OpenglStateMultTextureMultSample::isUseFrameBuffer()
{
	return true;
}
