...
bool  OpenglStateReflect::isUseReflect()
{
	return true;
}
...
bool OpenglStateReflect::isLihgtAction()
{
	return false;
}

int  OpenglStateReflect::getPointLights()
{
	return 0;
}

bool OpenglStateReflect::isShowLight()
{
	return false;
}
...
void OpenglStateReflect::enableLightVertexAttribArray()
{
	GLint posLocation = _glUtils->getAttribLocation(_shaderProgram, "aPos");
