...
OpenglStateMultTextureMaterialMapSpotLight::OpenglStateMultTextureMaterialMapSpotLight()
{
	OpenglState::OpenglState();
}

bool OpenglStateMultTextureMaterialMapSpotLight::init(string vertFile, string fragFile)
{
	float vertices[] = {
	...
	*/
	...
	// 聚光源切光角
	setFloat(_shaderProgram, "light.cutOff", glm::cos(glm::radians(12.5f)));
	setFloat(_shaderProgram, "light.outerCutOff", glm::cos(glm::radians(17.5f)));


	return true;
}
bool OpenglStateMultTextureMaterialMapSpotLight::isUseEBORender()
{
	return false;
}
...
void OpenglStateMultTextureMaterialMapSpotLight::rendeCommand()
{
	...
	*/
	...
	setVec3(_shaderProgram, "lightPos", cameraPos);		// 光源的位置就是观察者的位置
	setVec3(_shaderProgram, "light.position", cameraPos);// 位于观察者位置的聚光
	setVec3(_shaderProgram, "light.direction", cameraFront);
...
int OpenglStateMultTextureMaterialMapSpotLight::getShaderIndex()
{
	return 15;
}

void OpenglStateMultTextureMaterialMapSpotLight::enableVertexAttribArray()
{
...
void OpenglStateMultTextureMaterialMapSpotLight::enableLightVertexAttribArray()
{
	GLint posLocation = _glUtils->getAttribLocation(_shaderProgram, "aPos");
