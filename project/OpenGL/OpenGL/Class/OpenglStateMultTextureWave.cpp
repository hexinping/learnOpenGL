...
bool OpenglStateMultTextureWave::init(string vertFile, string fragFile)
{
	float vertices[] = {
		//     ---- 位置 ----       ---- 颜色 ----     - 纹理坐标 -
	...
	_texture0 = loadTexture("resource/water1.jpg", GL_TEXTURE0);
	_texture1 = loadTexture("resource/water_normal.jpg", GL_TEXTURE1);
...
bool OpenglStateMultTextureWave::isUseEBORender()
{
	return true;
}


void OpenglStateMultTextureWave::rendeCommand()
{
...
int OpenglStateMultTextureWave::getShaderIndex()
{
	return 40;
}

void OpenglStateMultTextureWave::enableVertexAttribArray()
{
