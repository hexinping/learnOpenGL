...
bool OpenglStateMultTextureMaterialMapMultLights::isLihgtAction()
{
	return false;
}

int  OpenglStateMultTextureMaterialMapMultLights::getPointLights()
{
	return 4;
}

bool OpenglStateMultTextureMaterialMapMultLights::isShowLight()
{
	return true;
}
