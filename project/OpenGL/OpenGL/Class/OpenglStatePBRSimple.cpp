...
string OpenglStatePBRSimple::getModelFile()
{
	string str("resource/objects/nanosuit/nanosuit.obj");
	return str;
}

bool OpenglStatePBRSimple::isRenderModel()
{
	return true;
}

bool OpenglStatePBRSimple::isUseSSAO()
{
	return true;
}

bool OpenglStatePBRSimple::isUseMSAA()
{
	return false;
}
...
void OpenglStatePBRSimple::rendeCommand()
{
	...
	// room cube
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(0.0, 7.0f, 2.0f));
...
bool OpenglStatePBRSimple::afterModleRender()
{
