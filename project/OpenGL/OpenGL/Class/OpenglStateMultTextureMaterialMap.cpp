...
bool OpenglStateMultTextureMaterialMap::isLihgtAction()
{
	return true;
}

int  OpenglStateMultTextureMaterialMap::getPointLights()
{
	return 1;
}

bool OpenglStateMultTextureMaterialMap::isShowLight()
{
	return true;
}
