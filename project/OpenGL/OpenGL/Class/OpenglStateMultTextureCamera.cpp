...
bool OpenglStateMultTextureCamera::isUseEBORender()
{
	return false;
}

void OpenglStateMultTextureCamera::rendeCommand()
{
...
int OpenglStateMultTextureCamera::getShaderIndex()
{
	return 9;
}

void OpenglStateMultTextureCamera::enableVertexAttribArray()
{
